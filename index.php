...
<body>
    ...
    <br>
        ...
        <div class="kiiratas">
                    <form method="post">
                        <input type="submit" name="exportData" value="Adatok exportálása">
                    </form>
                <?php
                ...
                if(isset($_POST['exportData'])) {
                    ...
                    products.name AS product_name, products.quantity AS quantity, products.min_qty AS min_qty, products.price AS price
                    FROM stores
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        $header = array("Áruház neve", "Cím", "Polc", "Sor", "Oszlop", "Termék", "Mennyiség", "Minimális mennyiség", "Ár");
                        fputcsv($file, $header);
                        ...
                        echo "Az adatok sikeresen exportálva lettek!";
                    } else {
                        echo "Nincs adat az exportáláshoz.";
                    }
        ...
        <div class="kiiratas">
            <p>____________________________________________________________________________________________</p> <!-- ideiglenes -->
        </div>
        <div class="kiiratas">
        <?php
$servername = "localhost";
...
if ($result->num_rows > 0) {
    ...
    echo "<option value='' disabled selected>Válassz boltot</option>"; 
    while($row = $result->fetch_assoc()) {
